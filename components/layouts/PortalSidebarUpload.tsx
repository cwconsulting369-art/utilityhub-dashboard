  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
      ...
      {!file ? (
        ...
        >
          {/* Cloud-Upload-Icon */}
          <svg width="56" height="56" viewBox="0 0 24 24" fill="none" stroke={dragOver ? "var(--primary-bright)" : "rgba(255,255,255,0.5)"} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
