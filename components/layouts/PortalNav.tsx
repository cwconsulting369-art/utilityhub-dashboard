              ...
              {profileOpen && (
                ...
                >
                  ...
                  <button
                    ...
                    style={{ width: "100%", padding: "var(--space-2) var(--space-4)", display: "flex", alignItems: "center", gap: "var(--space-2)", textAlign: "left", fontSize: "var(--text-sm)", color: "#f85149", background: "transparent", border: "none", cursor: "pointer", borderTop: "1px solid var(--border)", transition: "background 120ms ease" }}
