              ...
              {profileOpen && (
                ...
                >
                  ...
                  <a
                    ...
                    style={{ display: "flex", alignItems: "center", gap: "var(--space-3)", padding: "var(--space-3) var(--space-5)", fontSize: "var(--text-sm)", color: "var(--text)", textDecoration: "none", transition: "background 120ms ease" }}
                  ...
                  <button
                    ...
                    style={{ width: "100%", padding: "var(--space-3) var(--space-5)", display: "flex", alignItems: "center", gap: "var(--space-3)", textAlign: "left", fontSize: "var(--text-sm)", color: "#f85149", background: "transparent", border: "none", cursor: "pointer", borderTop: "1px solid var(--border)", transition: "background 120ms ease" }}
